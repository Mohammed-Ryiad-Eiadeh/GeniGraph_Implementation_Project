...
Now, if you want to applay these approaches on your own datasets (database since I believe that text file is a form of database), then you need to mimic our data format by following these instruction:
