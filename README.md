...
Now, if you want to applay these approaches on your own datasets (database since I believe that any object holds data that can be retrieved and processed can be called or considered as a database, and text file is one of those forms or objects), then you need to mimic our data format by following these instruction:
