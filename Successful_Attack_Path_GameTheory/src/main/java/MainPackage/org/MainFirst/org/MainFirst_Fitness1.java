...
/**
 * This class is used as the main class for the first scenario upon first fitness function
 */
public class MainFirst_Fitness1 {
    public static void main(String[] args) {
        ...
        System.out.println(assetsLossValues.length);
