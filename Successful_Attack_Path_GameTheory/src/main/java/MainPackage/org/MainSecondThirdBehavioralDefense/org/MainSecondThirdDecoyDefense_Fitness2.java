...
/**
 * This class is used as the main class for the second and third scenarios of proactive decoy according to bahavioral defender upon the second fitness function
 */
public class MainSecondThirdDecoyDefense_Fitness2 {
