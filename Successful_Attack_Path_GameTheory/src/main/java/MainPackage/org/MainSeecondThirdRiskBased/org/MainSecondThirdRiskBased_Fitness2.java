package MainPackage.org.MainSeecondThirdRiskBased.org;
...
/**
 * This class is used as the main class for the second and third scenarios upon the second fitness function
 */
public class MainSecondThirdRiskBased_Fitness2 {
    public static void main(String[] args) {
        ...
        var edgeCuts = proactiveDefence.DefenseTopPaths(listOfAttackers);
