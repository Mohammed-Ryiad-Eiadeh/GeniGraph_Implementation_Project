package MainPackage.org.MainSecondThirdBehavioralDefender.org;
...
/**
 * This class is used as the main class for the second-third scenario according to bahavioral defender upon the second fitness function
 */
public class MainSecondThirdBehavioralDefender_Fitness2 {
    public static void main(String[] args) {
        ...
        listOfAttackers.forEach(ofAttacker -> IntStream.range(0, ofAttacker.size() - 1).
                mapToDouble(i -> attackDefenceGraph[ofAttacker.get(i) - 1][ofAttacker.get(i + 1) - 1].totalInvest()).
                forEach(edgeWeights::add));
