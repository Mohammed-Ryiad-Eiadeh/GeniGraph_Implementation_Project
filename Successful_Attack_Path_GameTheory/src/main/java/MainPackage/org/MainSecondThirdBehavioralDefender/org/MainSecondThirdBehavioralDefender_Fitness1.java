...
/**
 * This class is used as the main class for the second-third scenario according to bahavioral defender upon the first fitness function
 */
public class MainSecondThirdBehavioralDefender_Fitness1 {
