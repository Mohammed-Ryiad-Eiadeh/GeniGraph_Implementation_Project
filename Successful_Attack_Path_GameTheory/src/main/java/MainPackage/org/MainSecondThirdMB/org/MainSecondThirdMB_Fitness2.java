package MainPackage.org.MainSecondThirdMB.org;
...
/**
 * This class is used to show the enhancement we gain after allocating our spare investments among Markove Blanket Nodes upon the second fitness function
 */
public class MainSecondThirdMB_Fitness2 {
    public static void main(String[] args) {
        ...
        System.out.println("\nBest path is : " + bestAttackPathByDE + "\t" + "With the score of : " +
                FFun.evaluateSolution(engin.getBestCurrent()) + "\t, And the value of loss if the attacker sucsses is : " +
                task.getValueOfLoss(bestAttackPathByDE, assetsLossValues));
