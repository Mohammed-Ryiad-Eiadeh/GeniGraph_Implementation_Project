...
/**
 * This class is used to show the enhancement we gain after allocating our spare investments among Markove Blanket Nodes upon the first fitness function
 */
class MainSecondThirdMB_Fitness1 {
