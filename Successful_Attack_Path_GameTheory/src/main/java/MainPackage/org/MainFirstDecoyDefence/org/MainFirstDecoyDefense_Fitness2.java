...
/**
 * This class is used as the main class for the first scenario of proactive decoy according to bahavioral defender upon the second fitness function
 */
public class MainFirstDecoyDefense_Fitness2 {
