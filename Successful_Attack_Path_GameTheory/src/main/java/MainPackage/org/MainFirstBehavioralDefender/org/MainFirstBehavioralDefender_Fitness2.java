package MainPackage.org.MainFirstBehavioralDefender.org;
...
/**
 * This class is used as the main class for the first scenario of behavioral defender according to bahavioral defender upon the second fitness function
 */
public class MainFirstBehavioralDefender_Fitness2 {
    public static void main(String[] args) {
        // Select the test case or the graph; construct the defenders; construct the adjacensy matrix; display the graph.
        var task = new GraphData(Graph.dset4);
