...
/**
 * This class is used as the main class for the first scenario of behavioral defender according to bahavioral defender upon the first fitness function
 */
public class MainFirstBehavioralDefender_Fitness1 {
