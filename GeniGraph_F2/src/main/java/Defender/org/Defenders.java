...
public class Defenders {
    ...
    public static double spareBudget_D1;
    public static double spareBudget_D2;
    public static double spareBudget_D3;
    ...
    public Defenders(double invest_d1, double invest_d2, double invest_d3) {
        if (invest_d1 < 0 || invest_d2 < 0 || invest_d3 < 0) {
    ...
    public double addSpareInvestFor_D1(double value) {
        if (spareBudget_D1 - value < 0)
            return spareBudget_D1 + this.invest_D1;
        else
        {
            spareBudget_D1 -= value;
            return value + this.invest_D1;
        }
    }
    ...
    public double addSpareInvestFor_D2(double value) {
        if (spareBudget_D2 - value < 0)
            return spareBudget_D2 + this.invest_D2;
        else
        {
            spareBudget_D2 -= value;
            return value + this.invest_D2;
        }
    }
    ...
    public double addSpareInvestFor_D3(double value) {
        if (spareBudget_D3 - value < 0)
            return spareBudget_D3 + this.invest_D3;
        else
        {
            spareBudget_D3 -= value;
            return value + this.invest_D3;
        }
    }
    ...
    public double totalInvest() {
        return this.getInvest_D1() + this.getInvest_D2() + this.getInvest_D3();
    }
}