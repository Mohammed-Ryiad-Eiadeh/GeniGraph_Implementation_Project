...
/**
 * This class is used as the main class for the third scenario
 */
    ...
    public static void main(String[] args) {
        ...
        for (var listOfAttacker : listOfAttackers) {
            for (var i = 0; i < listOfAttacker.size() - 1; i++) {
                ...
                edge.setInvest_D1(edge.getInvest_D1() + edge.addSpareInvestFor_D1((B1 * (FFun.evaluateSolution(listOfAttacker) / sumOfCost)) / (listOfAttacker.size() - 1)));
                edge.setInvest_D2(edge.getInvest_D2() + edge.addSpareInvestFor_D2((B2 * (FFun.evaluateSolution(listOfAttacker) / sumOfCost)) / (listOfAttacker.size() - 1)));
                edge.setInvest_D3(edge.getInvest_D3() + edge.addSpareInvestFor_D3((B3 * (FFun.evaluateSolution(listOfAttacker) / sumOfCost)) / (listOfAttacker.size() - 1)));
