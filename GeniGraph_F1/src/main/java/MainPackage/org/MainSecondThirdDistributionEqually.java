...
/**
 * This class is used as the main class for the second-third scenario equally distribution
 */
public class MainSecondThirdDistributionEqually {
    public static void main(String[] args) {
        ...
        // Set the spare budget of security resourcess for each defender and the following vales must be positive integers
